...
function RecruiterNavbar() {
  ...
  // Track global dark/light theme state matching CandidateNavbar
  ...
  // Extract a fallback initial from the email (e.g., "employer@techcorp.com" -> "E")
  const userInitial = auth?.email ? auth.email.charAt(0).toUpperCase() : "R";
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex flex-col text-left">
            ...
            <span className="text-xs text-slate-400 dark:text-slate-500">
              {auth?.email || "recruiter@interviewhub.ai"}
            </span>
          </div>
        </div>
